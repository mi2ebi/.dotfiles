...
(defun pacifism--delete-sexp ()
  "Delete forward sexp without polluting the kill ring."
  (interactive)
  (delete-region (point) (save-excursion (forward-sexp) (point))))

(defun pacifism--backward-delete-sexp ()
  "Delete forward sexp without polluting the kill ring."
  (interactive)
...
(global-set-key (kbd "M-DEL")           #'pacifism--backward-delete-word)
...
(global-set-key (kbd "C-M-k")           #'pacifism--delete-sexp)
(global-set-key (kbd "C-M-<backspace>") #'pacifism--backward-delete-sexp)
...
(define-key pacifism--kill-map (kbd "x")   #'kill-sexp)
(define-key pacifism--kill-map (kbd "X")   #'backward-kill-sexp)
